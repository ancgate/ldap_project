...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fr3d_ldap.security.authentication.provider.main' => 'getFr3dLdap_Security_Authentication_Provider_MainService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/MAMP/htdocs/ldap_project/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Applications/MAMP/htdocs/ldap_project/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Applications/MAMP/htdocs/ldap_project/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'ldap_project', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Applications/MAMP/htdocs/ldap_project/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Setsuna\\PrivateBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Setsuna\\PrivateBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Setsuna\\PrivateBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'fr3d_ldap.ldap_driver.legacy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FR3D\LdapBundle\Driver\LegacyLdapDriver A FR3D\LdapBundle\Driver\LegacyLdapDriver instance.
     */
    protected function getFr3dLdap_LdapDriver_LegacyService()
    {
        return $this->services['fr3d_ldap.ldap_driver.legacy'] = new \FR3D\LdapBundle\Driver\LegacyLdapDriver(array('host' => 'ldap.forumsys.com', 'port' => 389, 'username' => 'euclid', 'password' => 'password', 'bindRequiresDn' => true, 'baseDn' => 'dc=example, dc=com', 'useStartTls' => false, 'useSsl' => false, 'accountFilterFormat' => '(&(ObjectClass=Person))'), 3, $this->get('monolog.logger.ldap_driver'));
    }

    /**
     * Gets the 'fr3d_ldap.ldap_driver.zend' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FR3D\LdapBundle\Driver\ZendLdapDriver A FR3D\LdapBundle\Driver\ZendLdapDriver instance.
     */
    protected function getFr3dLdap_LdapDriver_ZendService()
    {
        return $this->services['fr3d_ldap.ldap_driver.zend'] = new \FR3D\LdapBundle\Driver\ZendLdapDriver(new \Zend\Ldap\Ldap(array('host' => 'ldap.forumsys.com', 'port' => 389, 'username' => 'euclid', 'password' => 'password', 'bindRequiresDn' => true, 'baseDn' => 'dc=example, dc=com', 'useStartTls' => false, 'useSsl' => false, 'accountFilterFormat' => '(&(ObjectClass=Person))')), $this->get('monolog.logger.ldap_driver'));
    }

    /**
     * Gets the 'fr3d_ldap.ldap_manager.default' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FR3D\LdapBundle\Ldap\LdapManager A FR3D\LdapBundle\Ldap\LdapManager instance.
     */
    protected function getFr3dLdap_LdapManager_DefaultService()
    {
        return $this->services['fr3d_ldap.ldap_manager.default'] = new \FR3D\LdapBundle\Ldap\LdapManager($this->get('fr3d_ldap.ldap_driver.zend'), $this->get('fos_user.user_manager'), array('baseDn' => 'dc=example, dc=com', 'filter' => '(&(ObjectClass=Person))', 'attributes' => array(0 => array('ldap_attr' => 'samaccountname', 'user_method' => 'setUsername'), 1 => array('ldap_attr' => 'sn', 'user_method' => 'setName'), 2 => array('ldap_attr' => 'preferredlanguage', 'user_method' => 'setLanguage'), 3 => array('ldap_attr' => 'mail', 'user_method' => 'setEmail'))));
    }

    /**
     * Gets the 'fr3d_ldap.security.authentication.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FR3D\LdapBundle\Security\Authentication\LdapAuthenticationProvider A FR3D\LdapBundle\Security\Authentication\LdapAuthenticationProvider instance.
     */
    ...
    /**
     * Gets the 'fr3d_ldap.security.authentication.provider.main' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['fr3d_ldap.security.authentication.provider.main'] = new \FR3D\LdapBundle\Security\Authentication\LdapAuthenticationProvider($this->get('security.user_checker'), 'main', $this->get('security.user.provider.concrete.chain_provider'), $this->get('fr3d_ldap.ldap_manager.default'), true);
    }

    /**
     * Gets the 'fr3d_ldap.security.user.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FR3D\LdapBundle\Security\User\LdapUserProvider A FR3D\LdapBundle\Security\User\LdapUserProvider instance.
     */
    ...
    /**
     * Gets the 'fr3d_ldap.validator.unique' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FR3D\LdapBundle\Validator\UniqueValidator A FR3D\LdapBundle\Validator\UniqueValidator instance.
     */
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/MAMP/htdocs/ldap_project/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'monolog.logger.ldap_driver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/MAMP/htdocs/ldap_project/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Setsuna\\PrivateBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($k, array('always_use_default_target_path' => true, 'default_target_path' => '/profile', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $m->setProviderKey('main');

        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $k, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a);

        $o = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $g, $k, 'main', $m, $n, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $h);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('fr3d_ldap.security.user.provider'), 2 => $this->get('fos_user.user_manager')), 'main', $a, $c), 2 => $l, 3 => $o, 4 => $o, 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '564215f1e37ec', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $j, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $k, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $k, '/login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/MAMP/htdocs/ldap_project/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Applications/MAMP/htdocs/ldap_project/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/MAMP/htdocs/ldap_project/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Applications/MAMP/htdocs/ldap_project/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Applications/MAMP/htdocs/ldap_project/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/src/Setsuna/PrivateBundle/Resources/views', 'SetsunaPrivate');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/app/Resources/views');
        $instance->addPath('/Applications/MAMP/htdocs/ldap_project/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'fr3d_ldap.validator.unique' => 'fr3d_ldap.validator.unique')));
        $instance->setTranslator($this->get('translator'));
        $instance->setTranslationDomain('validators');
        $instance->addXmlMappings(array(0 => '/Applications/MAMP/htdocs/ldap_project/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/Applications/MAMP/htdocs/ldap_project/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation.xml'));
        ...
        $instance->addXmlMapping('/Applications/MAMP/htdocs/ldap_project/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/DependencyInjection/Compiler/../../Resources/config/storage-validation/orm.xml');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Applications/MAMP/htdocs/ldap_project/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/MAMP/htdocs/ldap_project/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/MAMP/htdocs/ldap_project/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/MAMP/htdocs/ldap_project/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/ldap_project/app/cache/dev',
            'kernel.logs_dir' => '/Applications/MAMP/htdocs/ldap_project/app/logs',
            'kernel.bundles' => array(
                ...
                'SetsunaPrivateBundle' => 'Setsuna\\PrivateBundle\\SetsunaPrivateBundle',
            ...
            'debug.container.dump' => '/Applications/MAMP/htdocs/ldap_project/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Applications/MAMP/htdocs/ldap_project/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Applications/MAMP/htdocs/ldap_project/app/cache/dev/profiler',
            ...
            'router.resource' => '/Applications/MAMP/htdocs/ldap_project/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/MAMP/htdocs/ldap_project/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/MAMP/htdocs/ldap_project/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/MAMP/htdocs/ldap_project/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Applications/MAMP/htdocs/ldap_project/app/../web',
            'assetic.write_to' => '/Applications/MAMP/htdocs/ldap_project/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/ldap_project/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'Setsuna\\PrivateBundle\\Entity\\User',
